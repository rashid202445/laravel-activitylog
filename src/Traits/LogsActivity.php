...
use RashidSiaghi\Activitylog\ActivityLogStatus;
use RashidSiaghi\Activitylog\Contracts\LoggablePipe;
use RashidSiaghi\Activitylog\EventLogBag;
use RashidSiaghi\Activitylog\LogOptions;
...
trait LogsActivity
{
    ...
    public static function logChanges(Model $model): array
    {
        ...
        foreach ($attributes as $attribute) {
            // // ✅ دعم belongsToMany أو morphToMany أو hasMany عبر اسم العلاقة فقط
            // if (method_exists($model, $attribute) && $model->$attribute() instanceof \Illuminate\Database\Eloquent\Relations\Relation) {
            ...
            //         $relatedIds = $relation->allRelatedIds()->sort()->values()->toArray();
            //         $changes[$attribute] = $relatedIds;
            //         continue;
            //     }
            ...
            //         $related = $relation->get(['id'])->pluck('id')->sort()->values()->toArray();
            //         $changes[$attribute] = $related;
            //         continue;
            //     }
            // }

            // // ✅ العلاقات مع dot notation (مثلاً: phones.number)
